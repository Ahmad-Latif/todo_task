											...
											<table cellspacing="0" cellpadding="0" border="0" align="center" style="font-family:Arial,Tahoma,Helvetica,sans-serif; color:#4c505d;">
												<tbody><tr>
													<td valign="bottom" align="center"><a href="">
														<img style="width:200px" alt="img" src="{{asset('public/assets/images/email_logo.jpeg')}}" style="margin-bottom:0px" title="image" vspace="0" hspace="0" border="0"></a></td>
													</tr>
												</tbody></table>
											</td>
										</tr>
									...
									<tbody><tr>
										<td valign="top" align="center">
											<table width="100%" cellspacing="0" cellpadding="0" border="0" align="center" style="font-family:Arial,Tahoma,Helvetica,sans-serif; color:#4c505d;">
												...
												<tr>
													<td>
														Please click on the verify button to verify your account.
														The link will expire after 1 hour for security reason.
													</td>
												</tr>
												...
												<tr>
													<td width="auto" valign="top" align="center">
														...
														<table width="300" cellspacing="0" cellpadding="0" border="0" align="center">
															<tbody><tr>
                                                                <p style="color:#4c505d;margin-bottom:25px; font-family:Arial,Tahoma,Helvetica,sans-serif;">
																	<a href="<?php echo $link; ?>" style="border: 2px solid #15c;padding: 10px;background: #fff;color: #15c;text-decoration: none;">Verify</a>
																</p>
															</tr>
												...
												<tr>
													<td style="text-align:left;font-size:16px;color:#4c505d;line-height:20px" >
														<br>
														<p style="color:#4c505d;margin-top:0px;color:#4c505d; font-family:Arial,Tahoma,Helvetica,sans-serif;">We hope you will enjoy your stay.</p>
														<br>
														<p style="color:#4c505d;margin-top:0px;color:#4c505d; font-family:Arial,Tahoma,Helvetica,sans-serif;">Kind regards,</p>
														<p style="color:#4c505d;margin-top:0px;color:#4c505d; font-family:Arial,Tahoma,Helvetica,sans-serif;">To Do List team</p>
													</td>
												</tr>
										...
										<table width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#efefef" align="center">
											<tbody>
												...
												<tr>
													...
													© 2020 udua. All rights reserved</td>
												</tr>
											</tbody></table>
										</td>
									</tr>
